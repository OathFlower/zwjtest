...
@Repository
@Slf4j
public class RecommendQrcodeRepository extends XbbRepository<RecommendQrcodeEntity> {


    public RecommendQrcodeRepository(NamedParameterJdbcTemplate jdbcTemplate) {
        super(jdbcTemplate);
