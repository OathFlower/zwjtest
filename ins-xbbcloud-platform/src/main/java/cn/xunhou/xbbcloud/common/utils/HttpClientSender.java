...
public class HttpClientSender {
    ...
    public static String sendHttpPost(String host, String method, String urlParams, String sendData) {
        ...
        if (responseCode == 200) {
            ...
            throw GrpcException.asRuntimeException(responseCode + ":" + responseString);
        }
    }
    ...
    public static byte[] sendHttpGet(String host, String method, String urlParams) {
        ...
        if (responseCode == 200) {
            ...
            throw GrpcException.asRuntimeException(responseCode + "");
        }
    }
                ...
                try {
                    ...
                    if (responseBody != null) {
                        ...
                        try {
                            ...
                            if (respBodySize <= 0)
                                throw GrpcException.asRuntimeException("Invalid respBodySize: " + respBodySize);
                            responseBytes = new byte[respBodySize];
                            if (respStream.read(responseBytes) != respBodySize)
                                throw GrpcException.asRuntimeException("Read respBody Error");
                        } catch (Exception e) {
                    ...
                    try {
                        ...
                        throw GrpcException.asRuntimeException(e2.getMessage());
                    }
                    throw GrpcException.asRuntimeException(e.getMessage());
                } catch (IOException e) {
//                    e.printStackTrace();
...
//        String loggerResponseString = getLoggerString(responseBytes, 256);
    ...
    private static Map<String, Object> sendGet(CloseableHttpClient httpClient, String url, Map<String, String> headers) {
        ...
        if (exception != null) {
            throw GrpcException.asRuntimeException(exception.getMessage());
        }
        Map<String, Object> response = new HashMap<String, Object>();
        response.put("responseCode", responseCode);
        response.put("responseData", responseBytes);
...
//        }
    ...
    private static class HttpClientUtils {
        ...
        // 默认读取超时
        private static int defaultReadTimeout = 45000;
