...
public class RSAUtils {
    ...
    public static String calcRsaSign(String developerId, String privateKey, String host, String methodName, String rtick, String urlParams, String requestBody) {
        ...
        String rsaSign = "";
//        try {
//            rsaSign = RsaPlus.getInstance().encryptByPrivateKey(signString, privateKey);
//        }catch (Exception e){
//            monitorLog.log("calcRsaSign异常",e);
//            throw new BizException("calcRsaSign异常");
//        }
        rsaSign = calcRsaSign(privateKey, signString);
